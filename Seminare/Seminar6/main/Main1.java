...
public class Main1 {
	...
	public static void main(String[] args) {
		...
		Reservation reservation2 = builder.setterIsWindowPosition(true).getReservation();
		...
		//Reservation reservation3 = builder2.setterErgoChairs(true).setterMusicGenre("pop").getReservation();
